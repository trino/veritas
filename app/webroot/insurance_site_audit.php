...
<table class="" style="font-size: 13px;">
    ...
    <tr>
        ...
        <td><strong><?php echo $this->requestAction("dashboard/translate/Time");?> : </strong><input type="text" name="time" class="timepicker" style="width:100px;" value="<?php echo $time;?>" /></td>
        <td><strong><?php echo $this->requestAction("dashboard/translate/Guard on duty")?></strong></td><td><input type="text" name="guard_on_duty" value="<?php echo $guard_on_duty;?>" /></td><td><strong>Final score</strong></td><td><input type="text" name="final_score" class="final_score" readonly="" value="<?php echo $final_score;?>" style="background:#FFF;border:1px solid #fff;width:30px;" />/10</td>
    </tr>
    <tr>
