<td colspan="3" style="padding: 0;">
    <table>
        <tr><td colspan="2">Notice Of Termination</td></tr>
        ...
        <tr><td><input type="checkbox" value="1" name="termination[quit]" <?php echo (isset($termination['Noticeoftermination']['quit']) && $termination['Noticeoftermination']['quit']=='1')?"checked='checked'":'';?> />&nbsp;Quit(check all the applies)
                <table>
                    ...
                    <tr><td><input type="checkbox" value="1" name="termination[job_dissatisfaction]" <?php echo (isset($termination['Noticeoftermination']['job_dissatisfaction']) && $termination['Noticeoftermination']['job_dissatisfaction']=='1')?"checked='checked'":'';?>/>&nbsp;Job Dissatisfaction</td></tr>
                    ...
                    <tr><td><input type="checkbox" value="1" name="termination[family_emergency]" <?php echo (isset($termination['Noticeoftermination']['family_emergency']) && $termination['Noticeoftermination']['family_emergency']=='1')?"checked='checked'":'';?>/>&nbsp;Family Emergency</td></tr>
                    ...
                    <tr><td><input type="checkbox" value="1" name="termination[illness]" <?php echo (isset($termination['Noticeoftermination']['illness']) && $termination['Noticeoftermination']['illness']=='1')?"checked='checked'":'';?>/>&nbsp;Illness/Injury</td></tr>
                    ...
                    <tr><td><input type="checkbox" value="1" name="termination[other]" <?php echo (isset($termination['Noticeoftermination']['other']) && $termination['Noticeoftermination']['other']=='1')?"checked='checked'":'';?>/>&nbsp;Other</td></tr>
        ...
        <tr><td><input type="checkbox" value="1" name="termination[discharged]"  <?php echo (isset($termination['Noticeoftermination']['discharged']) && $termination['Noticeoftermination']['discharged']=='1')?"checked='checked'":'';?>/>&nbsp;Discharged (check all that applies)
                <table>
                    ...
                    <tr><td><input type="checkbox" value="1" name="termination[other2]"  <?php echo (isset($termination['Noticeoftermination']['other2']) && $termination['Noticeoftermination']['other2']=='1')?"checked='checked'":'';?>/>&nbsp;Other</td></tr>
        ...
        <tr><td><input type="radio" value="1" name="termination[warnings]"  <?php echo (isset($termination['Noticeoftermination']['warnings']) && $termination['Noticeoftermination']['warnings']=='1')?"checked='checked'":'';?>/>&nbsp;Yes</td></tr>
        <tr><td><input type="radio" value="0" name="termination[warnings]"  <?php echo (isset($termination['Noticeoftermination']['warnings']) && $termination['Noticeoftermination']['warnings']=='0')?"checked='checked'":'';?>/>&nbsp;No</td></tr>
        <tr><td>If Yes Explain&nbsp;<input type="text" name="termination[warning_detail]" value="<?php echo (isset($termination['Noticeoftermination']['warning_detail']) && $termination['Noticeoftermination']['warning_detail']!='')?$termination['Noticeoftermination']['warning_detail']:'';?>"/></td></tr>
        <tr><td>Dates of Prior Warnings:&nbsp;<input type="text" name="termination[warning_date]" class="activity_date" value="<?php echo (isset($termination['Noticeoftermination']['warning_date']) && $termination['Noticeoftermination']['warning_date']!='')?$termination['Noticeoftermination']['warning_date']:'';?>"/></td></tr>
