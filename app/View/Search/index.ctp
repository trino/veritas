...
<div id="table">
    ...
    foreach($docs as $k=>$d)
    {
       ...
       <tr>
            <td><?php  if($d['Document']['document_type']=='evidence')echo "Evidence (".$d['Document']['evidence_type'].')';elseif($d['Document']['document_type']=='report'){$act = $activity->find('first',array('conditions'=>array('document_id'=>$d['Document']['id'])));if($act){ echo "Report (";if($act['Activity']['report_type']==1)echo "Activity Log";if($act['Activity']['report_type']==2)echo "Mobile Inspection";if($act['Activity']['report_type']==3)echo "Mobile Security";if($act['Activity']['report_type']==4)echo "Security Occurrence";if($act['Activity']['report_type']==5)echo "Incident Report";if($act['Activity']['report_type']==6)echo "Sign Off";if($act['Activity']['report_type']==7)echo "Loss Prevention";if($act['Activity']['report_type']==8)echo "Static Site Audit";if($act['Activity']['report_type']==9)echo "Insurance Site Audit";if($act['Activity']['report_type']==10)echo "Site Sign In/Out";if($act['Activity']['report_type']==11)echo "Instructions And Site Assessment";if($act['Activity']['report_type']==12)echo "Personal Inspection";if($act['Activity']['report_type']==13)echo "Mobile Inspection";if($act['Activity']['report_type']==14)echo"Mobile Log";if($act['Activity']['report_type']==15)echo "Mobile Vehicle Trunk Inventory";if($act['Activity']['report_type']==16)echo"Vehicle Inventory";if($act['Activity']['report_type']==17)echo "Disciplinary Warning";if($act['Activity']['report_type']==18)echo "Injury & Illness";if($act['Activity']['report_type']==19)echo "Notice of Termination"; if($act['Activity']['report_type']==20)echo "Uniform Issue - Static and Retail"; echo ")";}}elseif($d['Document']['document_type']=='deployment_rate')echo "Deployment"; else echo $d['Document']['document_type'];if($d['Document']['document_type']=='deployment_rate'){if($d['Document']['client_approve']==1) echo " (Approved)";else if($d['Document']['client_approve']==2)echo " (Disapproved)";else echo " (Pending Approval)"; }if($d['Document']['document_type']=='orders'&& $o['Order']['complete']==0){echo "(Pending)";}
