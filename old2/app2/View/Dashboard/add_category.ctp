<div>
    ...
    Category Name : <input type="text" name="name" id="name" class="required" /><br />
    Category Description : <textarea name="description" id="editor1" class="description"></textarea><br />
    <script>
