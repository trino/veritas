					...
					<div class="container">
						...
						<div class="full">
							<div class="breadcrumbs">
								<p>You are here: <a href="<?php echo home_url(); ?>" style="margin-left: 10px;">Home</a> <span style="margin-left: 10px;">/</span><span style="margin-left: 10px;"><?php if ( is_day() ) : ?>
									<?php printf( __( 'Daily Archives: %s', 'agrgg' ), get_the_date() ); ?>
									<?php elseif ( is_month() ) : ?>
									<?php printf( __( 'Monthly Archives: %s', 'agrgg' ), get_the_date('F Y') ); ?>
									<?php elseif ( is_year() ) : ?>
									...
									?>
									<?php echo $curauth->display_name; ?></span></p>
							</div>
						</div>
