...
?>
<?php
    echo "<strong>By : </strong>" .$user['Register']['full_name']."<br>";
    echo "<strong>Budget :</strong> ". $ad['Ad']['budget'];
    ?>
</div>
...
<?php
    ...
    echo "Name : ".$contact['Contact']['name']."<div class='clear'></div>";
    echo "Email : ".$contact['Contact']['email']."<div class='clear'></div>";
    echo "Phone : ".$contact['Contact']['phone']."<div class='clear'></div>";
    echo "Mobile : ".$contact['Contact']['mobile']."<div class='clear'></div>";
    echo "Facebook : ".$contact['Contact']['facebook']."<div class='clear'></div>";
    echo "Twitter : ".$contact['Contact']['twitter']."<div class='clear'></div>";
    ?>
</div>
<div class="social-plugins bord">
