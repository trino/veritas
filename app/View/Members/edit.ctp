...
<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Other </span><input type="checkbox" name="canView_client_memo" <?php if(isset($v['Canview']['other']) && $v['Canview']['other']==1){?>checked="checked"<?php }?> /></td>
</tr>
</table>
</td>
</tr>
...
<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Other </span><input type="checkbox" name="canUpload_client_memo" <?php if(isset($u['Canupload']['other']) && $u['Canupload']['other']==1){?>checked="checked"<?php }?> /></td>
</tr>
</table>
</td>
</tr>
