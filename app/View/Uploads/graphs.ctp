...
<h3 class="page-title">
Document <?php echo $this->requestAction('dashboard/translate/Analytics');?>
</h3>
<ul class="breadcrumb">
	<li>
		<i class="icon-home"></i>
		<a href="<?=$base_url;?>dashboard"><?php echo $this->requestAction('dashboard/translate/Home');?></a> <span class="icon-angle-right"></span>
		<a href="<?=$base_url;?>uploads/stats">Document <?php echo $this->requestAction('dashboard/translate/Analytics');?></a>
	</li>
</ul>

<a href="stats" class="btn btn-primary"><?php echo $this->requestAction('dashboard/translate/Regular Report');?></a> 
<input type="button" onclick="window.print();" value="<?php echo $this->requestAction('dashboard/translate/Print Report');?>" class="btn btn-primary" style="" />
<br><br>


<div id="toprint">

<b>Document <?php echo $this->requestAction('dashboard/translate/Analytics');?></b>
<br>
...
<?php if(isset($all)){?>
<div class="span6">
<h4><?php echo $this->requestAction('dashboard/translate/All Documents');?></h4>
...
<h4><?php echo $this->requestAction('dashboard/translate/Evidence');?></h4>
...
<?php if(isset($report)){?>
<div class="span6"><br><br>
<h4><?php echo $this->requestAction('dashboard/translate/Reports');?></h4>
...
<div class="span6"><br><br>
<h4><?php echo $this->requestAction('dashboard/translate/Incident Reports');?></h4>
...
<?php if(isset($site)){?>
<div class="span6"><br><br>
<h4><?php echo $this->requestAction('dashboard/translate/Site Orders');?></h4>
...
<div class="span6"><br><br>
<h4><?php echo $this->requestAction('dashboard/translate/Employee');?></h4>
...
if(isset($client)){?>
<div class="span6"><br><br>
<h4><?php echo $this->requestAction('dashboard/translate/Client Feedback');?></h4>
...
var data= [
		{
			data: contract,
			label: '<?php echo $this->requestAction('dashboard/translate/Contracts');?>',
            points: { show: true }, 
		},
		{
			data: report,
			label: '<?php echo $this->requestAction('dashboard/translate/Reports');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: template,
			label: '<?php echo $this->requestAction('dashboard/translate/Templates');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: evidence,
			label: '<?php echo $this->requestAction('dashboard/translate/Evidence');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: KPIAudits,
			label: '<?php echo $this->requestAction('dashboard/translate/KPIAudits');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: training,
			label: '<?php echo $this->requestAction('dashboard/translate/Training');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: employee,
			label: '<?php echo $this->requestAction('dashboard/translate/Employee');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: siteOrder,
			label: '<?php echo $this->requestAction('dashboard/translate/Site Order');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: client_feedback,
			label: "<?php echo $this->requestAction('dashboard/translate/Client Feedback');?>",
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		}];
 var detailOptions = {            
...
<?php 
		...
		{
			data: Incident,
			label: "<?php echo $this->requestAction('dashboard/translate/Incident Report');?>",
            points: { show: true }, 
		},
		{
			data: Line,
			label: '<?php echo $this->requestAction('dashboard/translate/Line Crossing Sheet');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: Video,
			label: "<?php echo $this->requestAction('dashboard/translate/Incident Video');?>",
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: Shift,
			label: '<?php echo $this->requestAction('dashboard/translate/Shift Summary');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: Executive,
			label: '<?php echo $this->requestAction('dashboard/translate/Executive Summary');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: Average,
			label: '<?php echo $this->requestAction('dashboard/translate/Average Picket Count');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: Victim,
			label: '<?php echo $this->requestAction('dashboard/translate/Victim Statement');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: Miscellaneous,
			label: '<?php echo $this->requestAction('dashboard/translate/Miscellaneous');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		}];
 var detailOptions = {            
...
<?php 
			...
			foreach($report as $ke=>$data)
			{
                ...
                elseif($data['activities']['report_type'] == '8')
                {    
                    $count8 +=$data['0']['cnt'];
                ?>
                    Static_audit.push([<?php echo strtotime($data['0']['DateOnly'])*1000; ?><?php echo ", ".$data['0']['cnt'];?>]);
				<?php
                }
                elseif($data['activities']['report_type'] == '9')
                {    
                    $count9 +=$data['0']['cnt'];
                ?>
		...
		{
			data: Activity,
			label: '<?php echo $this->requestAction('dashboard/translate/Activity Log');?>',
            points: { show: true }, 
		},
		{
			data: Inspection,
		...
		{
			data: Security,
			label: '<?php echo $this->requestAction('dashboard/translate/Mobile Security');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: Occurance,
			label: '<?php echo $this->requestAction('dashboard/translate/Security Occurance');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: Sheets,
			label: '<?php echo $this->requestAction('dashboard/translate/Sign-off Sheets');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
        {
			data: Loss_p,
			label: '<?php echo $this->requestAction('dashboard/translate/Loss Prevention');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
        {
			data: Static_audit,
			label: '<?php echo $this->requestAction('dashboard/translate/Static Site Audit');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
        {
			data: Insurance_audit,
			label: "<?php echo $this->requestAction('dashboard/translate/Insurance Site Audit');?>",
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
...
<?php 
            ...
            var data= [
            	{
			data: a_a,
			label: "<?php echo $this->requestAction('dashboard/translate/Alarm Activation');?>",
            points: { show: true }, 
		},
		{
			data: b,
			label: '<?php echo $this->requestAction('dashboard/translate/Burglary');?>',
            points: { show: true }, 
		},
		{
			data: p_d,
			label: '<?php echo $this->requestAction('dashboard/translate/Property Damage');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
		...
		{
			data: s_l,
			label: '<?php echo $this->requestAction('dashboard/translate/Shoplift Loss');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: d_p,
			label: '<?php echo $this->requestAction('dashboard/translate/Disorderly Person');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: a_e,
			label: '<?php echo $this->requestAction('dashboard/translate/Accident - Employee');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
        {
			data: s_a,
			label: "<?php echo $this->requestAction('dashboard/translate/Shoplift Apprehension');?>",
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
        {
			data: f_a,
			label: '<?php echo $this->requestAction('dashboard/translate/Fraud Apprehension');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
        {
			data:a_c,
			label: '<?php echo $this->requestAction('dashboard/translate/Accident - Customer');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
        {
			data: s_r,
			label: '<?php echo $this->requestAction('dashboard/translate/Shoplift Recovery');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
        {
			data:f_r,
			label: '<?php echo $this->requestAction('dashboard/translate/Fraud Recovery');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
        {
			data: n_p_s,
			label: '<?php echo $this->requestAction('dashboard/translate/Non-Productive Stop');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
        {
			data: s_i_t,
			label: "<?php echo $this->requestAction('dashboard/translate/Suspicion Internal Theft');?>",
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
        {
			data: f_l,
			label: '<?php echo $this->requestAction('dashboard/translate/Fraud Loss');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		}
        ];
...
<?php 
		...
		{
			data: Post,
			label: '<?php echo $this->requestAction('dashboard/translate/Post Orders');?>',
            points: { show: true }, 
		},
		{
			data: Operational,
			label: '<?php echo $this->requestAction('dashboard/translate/Operational Memos');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: Site_maps,
			label: '<?php echo $this->requestAction('dashboard/translate/Site Maps');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: Forms,
			label: '<?php echo $this->requestAction('dashboard/translate/Forms');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		}];
 var detailOptions = {            
...
<?php 
		...
		{
			data: Observation,
			label: '<?php echo $this->requestAction('dashboard/translate/Observation');?>',
            points: { show: true }, 
		},
		{
			data: Feedback,
			label: '<?php echo $this->requestAction('dashboard/translate/Feedback');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: Non_compliance,
			label: '<?php echo $this->requestAction('dashboard/translate/Non Compliance');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: Great_job,
			label: '<?php echo $this->requestAction('dashboard/translate/Great Job');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		}];
 var detailOptions = {            
...
<?php 
		...
		{
			data: j_d,
			label: '<?php echo $this->requestAction('dashboard/translate/Job Descriptions');?>',
            points: { show: true }, 
		},
		{
			data: d_f_p,
			label: '<?php echo $this->requestAction('dashboard/translate/Drug Free Policy');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		},
		{
			data: Schedules,
			label: '<?php echo $this->requestAction('dashboard/translate/Schedules');?>',
			points: { show: true }, 
			lines: { lineWidth: 2, fill: false } 	
		}];
 var detailOptions = {            
