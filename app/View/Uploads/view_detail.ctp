...
if($type == 'Report')
{
    */?>
    ...
    <a href="<?php echo $this->webroot;?>uploads/download_doc/<?php echo $doc['Document']['id'];?>" class="btn btn-primary"><?php echo $this->requestAction('dashboard/translate/Word Doc');?></a>
