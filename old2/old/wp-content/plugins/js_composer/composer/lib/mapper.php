...
class WPBMap {
    ...
    protected static $user_sc = Array();
    protected static $user_categories = Array();
        ...
        if( empty($attributes['name']) ) {
            ...
            if($name != 'vc_column') {
                ...
                if(array_search($category, self::$categories)===false) {
                    ...
                    // Add to user categories if shortcode allowed in settings
                    if($user_allowed) self::$user_categories[] = $category;
                }
            ...
            if($user_allowed) self::$user_sc[$name] = self::$sc[$name];
