...
<div class="inputs" style="display: none;"><div class="left">Location</div><div class="right"><input type="text" name="location" class="" value="<?php echo $doc['Document']['location']; ?>" /></div><div class="clear"></div></div>
