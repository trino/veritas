    jQuery(document).ready(function(){
		...
		jQuery('#wpcrown_advance_clear_cache').click(function(){
			if(confirm('Are you sure you want to clear all cache'))
			{
				...
				jQuery.ajax({
  		    		...
  		    		success: function(msg){ 
  		    			jQuery('#wpcrown_advance_clear_cache').html('Successfully cleared. Click here to clear cache files again');
  		    		}
		    	});
			}
		...
		jQuery('#wpcrown_panel a').click(function(){
			jQuery('#wpcrown_panel a').removeClass('nav-tab-active');
		...
		{
			jQuery('#wpcrown_panel_general_a').click();
		}
		else
		{
		...
		jQuery( ".wpcrown_sortable" ).sortable({
		...
		jQuery( ".wpcrown_sortable" ).disableSelection();
		
		jQuery(".wpcrown_checkbox input").change(function(){
		...
		jQuery("#wpcrown_font").change(function(){
			var ppCufonFont = jQuery("#wpcrown_admin_url").val()+'/fonts/'+jQuery(this).val()+'.js';
			var script = document.createElement( 'script' );
			script.type = 'text/javascript';
			script.src = ppCufonFont;
			jQuery("body").append( script );
			Cufon.refresh('#wpcrown_preview_font');
			Cufon.replace('#wpcrown_preview_font');
		});
