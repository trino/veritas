<table style="border-bottom: 1px solid #DDD;">
        ...
        <tr><td >Last Date Actually Worked</td>
            <td><?php echo (isset($termination['Noticeoftermination']['last_date']))?$termination['Noticeoftermination']['last_date']:'';?></td>
        ...
        <tr><td><?php echo (isset($termination['Noticeoftermination']['quit']) && $termination['Noticeoftermination']['quit']=='1')?"&#10004":'&times';?>&nbsp;<strong>Quit(check all the applies)</strong>
                ...
                <!--<table style="display: <?php if(isset($termination['Noticeoftermination']['quit']) && $termination['Noticeoftermination']['quit']=='0')echo 'none';?>">-->
                    ...
                    <tr><td><?php echo (isset($termination['Noticeoftermination']['school_attendance']) && $termination['Noticeoftermination']['school_attendance']=='1')?"&#10004":'&times';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;School Attendence</td>
                        <td><?php echo (isset($termination['Noticeoftermination']['military_obligation']) && $termination['Noticeoftermination']['military_obligation']=='1')?"&#10004":'&times';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Military Obligation</td></tr>
                    <tr><td><?php echo (isset($termination['Noticeoftermination']['job_dissatisfaction']) && $termination['Noticeoftermination']['job_dissatisfaction']=='1')?"&#10004":'&times';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Job Dissatisfaction</td>
                        <td><?php echo (isset($termination['Noticeoftermination']['family_emergency']) && $termination['Noticeoftermination']['family_emergency']=='1')?"&#10004":'&times';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Family Emergency</td></tr>
                    <tr ><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Must Explain:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo (isset($termination['Noticeoftermination']['explain1']) && $termination['Noticeoftermination']['explain1']!='')?$termination['Noticeoftermination']['explain1']:'';?></td>
                        ...
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Must Explain:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo (isset($termination['Noticeoftermination']['explain2']) && $termination['Noticeoftermination']['explain2']!='')?$termination['Noticeoftermination']['explain2']:'';?></td></tr>
                    ...
                    <tr><td><?php echo (isset($termination['Noticeoftermination']['illness']) && $termination['Noticeoftermination']['illness']=='1')?"&#10004":'&times';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Illness/Injury</td>
                        <td><?php echo (isset($termination['Noticeoftermination']['other']) && $termination['Noticeoftermination']['other']=='1')?"&#10004":'&times';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Other</td></tr>
                    <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Must Explain:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo (isset($termination['Noticeoftermination']['explain3']) && $termination['Noticeoftermination']['explain3']!='')?$termination['Noticeoftermination']['explain3']:'';?></td>
                        ...
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Must Explain:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo (isset($termination['Noticeoftermination']['explain4']) && $termination['Noticeoftermination']['explain4']!='')?$termination['Noticeoftermination']['explain4']:'';?></td></tr>
        ...
        <tr><td><?php echo (isset($termination['Noticeoftermination']['discharged']) && $termination['Noticeoftermination']['discharged']=='1')?"&#10004":'&times';?>&nbsp;<strong>Discharged (check all that applies)</strong>
                ...
                <!--<table style="display: <?php if(isset($termination['Noticeoftermination']['discharged']) && $termination['Noticeoftermination']['discharged']=='0')echo 'none';?>">-->
                    ...
                    <tr><td><?php echo (isset($termination['Noticeoftermination']['failed_drug']) && $termination['Noticeoftermination']['failed_drug']=='1')?"&#10004":'&times';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Failed Drug Screen</td>
                    <td><?php echo (isset($termination['Noticeoftermination']['insubordination']) && $termination['Noticeoftermination']['insubordination']=='1')?"&#10004":'&times';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Insubordination</td></tr>
                    <tr><td><?php echo (isset($termination['Noticeoftermination']['violation_of_policy']) && $termination['Noticeoftermination']['violation_of_policy']=='1')?"&#10004":'&times';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Violation of Company Policy</td>
                    <td><?php echo (isset($termination['Noticeoftermination']['unsatisfactory']) && $termination['Noticeoftermination']['unsatisfactory']=='1')?"&#10004":'&times';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Unsatisfactory Performance</td></tr>
                    <tr><td><?php echo (isset($termination['Noticeoftermination']['client_request']) && $termination['Noticeoftermination']['client_request']=='1')?"&#10004":'&times';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Client Requested Removal</td>
                    <td><?php echo (isset($termination['Noticeoftermination']['other2']) && $termination['Noticeoftermination']['other2']=='1')?"&#10004":'&times';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Other</td></tr>
                    <tr><td></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Must Explain:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo (isset($termination['Noticeoftermination']['explain5']) && $termination['Noticeoftermination']['explain5']!='')?$termination['Noticeoftermination']['explain5']:'';?></td></tr>
