...
<tr class="inventory1_more" style="display: none;">
    <td colspan="2" style="padding: 0;border-top:none;">
        <table class="inventry_table" style="border-left:none!important;<?php if($this->params['action'] != 'view_detail'){?>border-bottom:1px solid #ddd;<?php }?>">
            ...
            <tr>
                <td width="10%" style="border-top: none;">Mobile Guard</td><td style="border-top: none;border-right:none!important;"><input type="text" name="inventory[guard]" value="<?php if(isset($inv) && $inv['MobileTrunk']['guard']){echo $inv['MobileTrunk']['guard'];}?>" class="required" /></td>
            </tr>
            <tr style="">
                <td width="10%">Date</td><td style="border-right:none!important;"><input type="text" name="inventory[date]" class="date_verify" value="<?php if(isset($inv) && $inv['MobileTrunk']['date']){echo $inv['MobileTrunk']['date'];}?>" /></td>
            </tr>
        </table>
        <?php if(isset($inv))
        {?>
       ...
       <?php  } ?>
        <table class="inventry_table righton" style="border-radius:0;">
            <tr>
                ...
                <td ><strong>Shirts - Red</strong></td><td >Inventory</td><td >Start Time</td><td style="border-right: none;">End Time</td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" class="time" value="<?php if(isset($inv) && $inv['MobileTrunk']['red2_s_end']){echo $inv['MobileTrunk']['red2_s_end'];}?>" name="inventory[red2_s_end]" /></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" value="<?php if(isset($inv) && $inv['MobileTrunk']['red2_m_end']){echo $inv['MobileTrunk']['red2_m_end'];}?>" class="time" name="inventory[red2_m_end]" /></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" value="<?php if(isset($inv) && $inv['MobileTrunk']['red2_l_end']){echo $inv['MobileTrunk']['red2_l_end'];}?>" class="time" name="inventory[red2_l_end]" /></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" value="<?php if(isset($inv) && $inv['MobileTrunk']['red2_xl_end']){echo $inv['MobileTrunk']['red2_xl_end'];}?>" class="time" name="inventory[red2_xl_end]" /></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" value="<?php if(isset($inv) && $inv['MobileTrunk']['red2_2xl_end']){echo $inv['MobileTrunk']['red2_2xl_end'];}?>" class="time" name="inventory[red2_2xl_end]" /></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" class="time" value="<?php if(isset($inv) && $inv['MobileTrunk']['red2_3xl_end']){echo $inv['MobileTrunk']['red2_3xl_end'];}?>" name="inventory[red2_3xl_end]" /></td>
            </tr>
            <tr>
                <td colspan="4"><strong>Accessories</strong></td>
                <td colspan="4" style="border-right: none;"><strong>Sweaters</strong></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" class="time" value="<?php if(isset($inv) && $inv['MobileTrunk']['sweater2_s_end']){echo $inv['MobileTrunk']['sweater2_s_end'];}?>" name="inventory[sweater2_s_end]" /></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" value="<?php if(isset($inv) && $inv['MobileTrunk']['sweater4_m_end']){echo $inv['MobileTrunk']['sweater4_m_end'];}?>" class="time" name="inventory[sweater4_m_end]" /></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" class="time" value="<?php if(isset($inv) && $inv['MobileTrunk']['sweater4_l_end']){echo $inv['MobileTrunk']['sweater4_l_end'];}?>" name="inventory[sweater4_l_end]" /></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" value="<?php if(isset($inv) && $inv['MobileTrunk']['sweater4_xl_end']){echo $inv['MobileTrunk']['sweater4_xl_end'];}?>" class="time" name="inventory[sweater4_xl_end]" /></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" value="<?php if(isset($inv) && $inv['MobileTrunk']['sweater2_2xl_end']){echo $inv['MobileTrunk']['sweater2_2xl_end'];}?>" class="time" name="inventory[sweater2_2xl_end]" /></td>
            </tr>
            <tr>
                ...
                <td colspan="4" style="border-right: none;"><strong>Books</strong></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" value="<?php if(isset($inv) && $inv['MobileTrunk']['books3_memo_end']){echo $inv['MobileTrunk']['books3_memo_end'];}?>" class="time" name="inventory[books3_memo_end]" /></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" class="time" value="<?php if(isset($inv) && $inv['MobileTrunk']['books3_insp_end']){echo $inv['MobileTrunk']['books3_insp_end'];}?>" name="inventory[books3_insp_end]" /></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" value="<?php if(isset($inv) && $inv['MobileTrunk']['books3_log_end']){echo $inv['MobileTrunk']['books3_log_end'];}?>" class="time" name="inventory[books3_log_end]" /></td>
            </tr>
            <tr>
                ...
                <td style="border-right: none;"><input type="text" class="time" value="<?php if(isset($inv) && $inv['MobileTrunk']['books3_report_end']){echo $inv['MobileTrunk']['books3_report_end'];}?>" name="inventory[books3_report_end]" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style=""><input type="text" value="<?php if(isset($inv) && $inv['MobileTrunk']['light_4_end']){echo $inv['MobileTrunk']['light_4_end'];}?>" class="time" name="inventory[light_4_end]" /></td>
                
            </tr>
            
            <tr>
                <td colspan="5"><strong>Inventory Given Out</strong></td><td rowspan="10" colspan="3" style="border-right: none;"><strong>Notes:</strong><br /><textarea rows="20"  name="inventory[notes]"><?php if(isset($inv) && $inv['MobileTrunk']['notes']){echo $inv['MobileTrunk']['notes'];}?></textarea></td>
            </tr>
            <tr>
