...
<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Client Feedback </span><input type="checkbox" name="canUpload_client_memo1" <?php if(isset($u['Canupload']['client_feedbak']) && $u['Canupload']['client_feedback']==1){?>checked="checked"<?php }?> />
</td>
</tr>
</table>
</td>
