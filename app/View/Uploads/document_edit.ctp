...
<select name="report_type" class="required reporttype">
    ...
    <option value="17" <?php if(isset($ac['Activity']['report_type']) && $ac['Activity']['report_type']=='17') echo "selected='selected'"?>><?php echo $this->requestAction('dashboard/translate/Disciplinary Warning');?></option>
</select>
</th>
</thead>
