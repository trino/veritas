<td colspan="3" style="padding: 0;" class="chk">
    <table>
        ...
        <tr><td><input type="checkbox" value="1" onclick="if(this.checked){$(this).parent().children().show('slow');}else{$(this).parent().children(':not(:input,strong)').hide('slow');}" name="termination[quit]" <?php echo (isset($termination['Noticeoftermination']['quit']) && $termination['Noticeoftermination']['quit']=='1')?"checked='checked'":'';?> />&nbsp;<strong>Quit(check all the applies)</strong>
        ...
        <tr><td><input type="checkbox" onclick="if(this.checked){$(this).parent().children().show('slow');}else{$(this).parent().children(':not(:input,strong)').hide('slow');}" value="1" name="termination[discharged]"  <?php echo (isset($termination['Noticeoftermination']['discharged']) && $termination['Noticeoftermination']['discharged']=='1')?"checked='checked'":'';?>/>&nbsp;<strong>Discharged (check all that applies)</strong>
