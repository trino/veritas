...
$page_postmetas = 
	array (
		...
		*/
		...
		array("section" => "Page title", "id" => "page_title", "type" => "text", "title" => "Enter page title", "std" => ""),

		array("section" => "Page slogan", "id" => "page_slogan", "type" => "text", "title" => "Enter page slogan", "std" => ""),

		array("section" => "Page background", "id" => "page_bg", "type" => "text", "title" => "Add here image url", "std" => ""),

		array("section" => "Page Slider", "id" => "page_slider", "type" => "select", "title" => "Select Page slider", "items" => array("none", "FlexSlider", "parallax")),
