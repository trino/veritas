...
<?php if($this->Session->read('view')=='1') { ?>
    <div class="blue main-box">
        ...
        <div class="view-all">
        <?php echo $this->Html->link('View All '.$contract.' Contracts','/uploads/view_doc/contract');?>
    ...
    <div class="green main-box">
        ...
        <div class="view-all">
         <?php echo $this->Html->link('View All '.$post_order.' Post Orders','/uploads/view_doc/post_order');?>
         <i class="icon-arrow-right m-icon-white"></i>
     </div>
     </div>
    <div class="shadow"></div>
    ...
    <div class="purple main-box">
        ...
        <div class="view-all">
        <?php echo $this->Html->link('View All '.$audits.' Audits','/uploads/view_doc/audits');?>
        <i class="icon-arrow-right m-icon-white"></i>
    </div>
    </div>
    <div class="shadow"></div>
    ...
    <div class="yello main-box">
        ...
        <div class="number">
        <?php echo $this->Html->link($training_manuals,'/uploads/view_doc/training_manuals');?>Training Manuals
        </div>
        <div class="view-all">
         <?php echo $this->Html->link('View All '.$training_manuals.' Training Manuals','/uploads/view_doc/training_manuals');?>
         <i class="icon-arrow-right m-icon-white"></i>
     </div>
     </div>
     <div class="shadow"></div>
