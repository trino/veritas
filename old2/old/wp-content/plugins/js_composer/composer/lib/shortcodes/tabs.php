...
class WPBakeryShortCode_VC_Tab extends WPBakeryShortCode {
    public function content( $atts, $content = null ) {
        ...
        $output .= "\n\t\t\t" . '<div id="tab-'. (empty($tab_id) ? sanitize_title( $title ) : $tab_id) .'" class="wpb_tab">';
    ...
    public function contentAdmin($atts, $content) {
        ...
        return '<div id="tab-'. (empty($tab_id) ? sanitize_title( $title ) : $tab_id) .'" class="row-fluid wpb_column_container wpb_sortable_container not-column-inherit">'. do_shortcode($content) . WPBakeryVisualComposer::getInstance()->getLayout()->getContainerHelper() . '</div>';
    }
}
