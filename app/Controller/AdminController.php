	...
	public function index() {
	   ...
	   if(isset($_POST['submit']))
       {
        ...
        if($q)
        {
            ...
            $this->Session->write('logo','afimaclogo.png'); 
            $this->Session->write(array('username'=>'admin','admin'=>1,'avatar'=>$q['User']['name_avatar'],'email'=>$q['User']['email'],'image'=>$q['User']['picture'],'id'=>$q['User']['id'],'view'=>'1','FMember'=>$q['User']['from_member']));
