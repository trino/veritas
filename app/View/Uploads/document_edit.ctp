...
<select name="report_type" class="required reporttype">
    ...
    <option value="12" <?php if(isset($ac['Activity']['report_type'])&&$ac['Activity']['report_type'] == '12') echo "selected='selected'"?>><?php echo $this->requestAction('dashboard/translate/Personal Inspection');?></option>
    <option value="13" <?php if(isset($ac['Activity']['report_type']) && $ac['Activity']['report_type']=='13') echo "selected='selected'"?>><?php echo $this->requestAction('dashboard/translate/Mobile Inspection');?></option>
    <option value="14" <?php if(isset($ac['Activity']['report_type']) && $ac['Activity']['report_type']=='14') echo "selected='selected'"?>><?php echo $this->requestAction('dashboard/translate/Mobile Log');?></option>
    <option value="15" <?php if(isset($ac['Activity']['report_type']) && $ac['Activity']['report_type']=='15') echo "selected='selected'"?>><?php echo $this->requestAction('dashboard/translate/Mobile Vehicle Trunk Inventory');?></option>
    <option value="16" <?php if(isset($ac['Activity']['report_type']) && $ac['Activity']['report_type']=='16') echo "selected='selected'"?>><?php echo $this->requestAction('dashboard/translate/Vehicle Inspection');?></option>
</select>
</th>
</thead>
...
'</tr>';
    ...
    if($('.reporttype').val()=='7' || $('.reporttype').val()=='8' || $('.reporttype').val()=='9' || $('.reporttype').val()=='10' || $('.reporttype').val()=='11'|| $('.reporttype').val()=='12'|| $('.reporttype').val()=='13'|| $('.reporttype').val()=='14'|| $('.reporttype').val()=='15'|| $('.reporttype').val()=='16')
       {
        if($('.reporttype').val()=='7')
        {
    ...
    $('.reporttype').change(function(){
       ...
       if(inc_type=='7' || $('.reporttype').val()=='8' || $('.reporttype').val()=='9'|| $('.reporttype').val()=='10' || $('.reporttype').val()=='11'|| $('.reporttype').val()=='12'|| $('.reporttype').val()=='13'|| $('.reporttype').val()=='14'|| $('.reporttype').val()=='15'|| $('.reporttype').val()=='16')
       {
            $('.loader').show();
            if($('.reporttype').val()=='8' || $('.reporttype').val()=='9'|| $('.reporttype').val()=='10' || $('.reporttype').val()=='11'|| $('.reporttype').val()=='12'|| $('.reporttype').val()=='13'|| $('.reporttype').val()=='14'|| $('.reporttype').val()=='15'|| $('.reporttype').val()=='16'){
                $('.description_tr').hide();
                $('.image_tr').hide();
                }
...
'You have <input readonly="readonly" type="text" name="countdown" id="countssss" style="background:none; border:0; padding:0; margin:0; text-align:center; border-radius:none; width:30px; box-shadow:none;" value="70" /> characters left.</font><br />');
    ...
    $('.client_more input').each(function(){
       ...
       <?php
    if(isset($ac['Activity']['report_type'])&& ($ac['Activity']['report_type'] == '7' || $ac['Activity']['report_type'] == '8' || $ac['Activity']['report_type'] == '9' || $ac['Activity']['report_type'] == '10' || $ac['Activity']['report_type'] == '11'|| $ac['Activity']['report_type'] == '12'|| $ac['Activity']['report_type'] == '13'|| $ac['Activity']['report_type'] == '14'|| $ac['Activity']['report_type'] == '15'|| $ac['Activity']['report_type'] == '16'))
    {
