<table style="border-bottom: 1px solid #DDD;">
        ...
        <tr><td><?php echo (isset($termination['Noticeoftermination']['quit']) && $termination['Noticeoftermination']['quit']=='1')?"&#10004":'&times';?>&nbsp;Quit(check all the applies)
        ...
        <tr><td><?php echo (isset($termination['Noticeoftermination']['discharged']) && $termination['Noticeoftermination']['discharged']=='1')?"&#10004":'&times';?>&nbsp;Discharged (check all that applies)
