...
<table class="table table-bordered loss" style="width: 100%;">
    ...
    <tr><td>INCIDENT TITLE<br />
        ...
        <td>DATE(YYYY-MM-DD)<br /><input class="required" type="text" name="store[date]" value="<?php if(isset($store['StoreInfo'])) echo $store['StoreInfo']['date'];?>" /></td>
        <td>DAY<br /><input type="text" name="store[day]" value="<?php if(isset($store['StoreInfo'])) echo $store['StoreInfo']['day'];?>" /></td>
        <td>TIME<br /><input type="text" name="store[time]" value="<?php if(isset($store['StoreInfo'])) echo $store['StoreInfo']['time'];?>" /></td>
    ...
    <tr><td>ADDRESS<br />
        ...
        <td>PHONE<br /><input type="text" name="store[phone]" value="<?php if(isset($store['StoreInfo'])) echo $store['StoreInfo']['phone'];?>" /></td>
        <td>EXTENSION<br /><input type="text" name="store[ext]" value="<?php if(isset($store['StoreInfo'])) echo $store['StoreInfo']['ext'];?>" /></td></tr>
</table>
<table class="table table-bordered loss2" style="width: 100%;">
    ...
    <tr><td colspan="2">SCARS/MARKS<br />
        ...
        <td colspan="2"><input type="radio" name="subject[adult]" value="adult" <?php if(isset($subject['SubjectInfo']) && $subject['SubjectInfo']['adult']=='adult') echo "checked='checked'";?>style="margin:0 5px;" /> ADULT<br />
        <input type="radio" name="subject[adult]" value="juvenile" <?php if(isset($subject['SubjectInfo']) && $subject['SubjectInfo']['adult']=='juvenile') echo "checked='checked'";?>style="margin:0 5px;" /> JUVENILE</td>
    ...
    <tr><td colspan="2">DRIVER LICENCE<br />
        ...
        <td colspan="2"><input type="radio" name="subject[employed]" value="employed" <?php if(isset($subject['SubjectInfo']) && $subject['SubjectInfo']['employed']=='employed') echo "checked='checked'";?>style="margin:0 5px;" /> EMPLOYED<br />
        <input type="radio" name="subject[employed]" value="unemployed" <?php if(isset($subject['SubjectInfo']) && $subject['SubjectInfo']['employed']=='unemployed') echo "checked='checked'";?>style="margin:0 5px;" /> UNEMPLOYED</td></tr>
    ...
    <tr><td colspan="4">REQUEST / COMMENTS MADE BY SUBJECT<br />
        ...
        <input type="radio" name="subject[compliance]" value="good" <?php if(isset($subject['SubjectInfo']) && $subject['SubjectInfo']['compliance']=='good') echo "checked='checked'";?> style="margin: 0 5px;" /> GOOD 
        <input type="radio" name="subject[compliance]" value="fair" <?php if(isset($subject['SubjectInfo']) && $subject['SubjectInfo']['compliance']=='fair') echo "checked='checked'";?>style="margin: 0 5px;" /> FAIR 
        <input type="radio" name="subject[compliance]" value="poor" <?php if(isset($subject['SubjectInfo']) && $subject['SubjectInfo']['compliance']=='poor') echo "checked='checked'";?>style="margin: 0 5px;" /> POOR 
        <input type="radio" name="subject[compliance]" value="resist" <?php if(isset($subject['SubjectInfo']) && $subject['SubjectInfo']['compliance']=='resist') echo "checked='checked'";?>style="margin: 0 5px;" /> RESIST
        <input type="radio" name="subject[compliance]" value="belligerent" <?php if(isset($subject['SubjectInfo']) && $subject['SubjectInfo']['compliance']=='belligerent') echo "checked='checked'";?>style="margin: 0 5px;" /> BELLIGERENT</td></tr>
...
<input type="text" value="<?php if(isset($subject['SubjectInfo'])) echo $subject['SubjectInfo']['cash'];?>" name="subject[cash]" /></td>
    <td>WEAPONS<br />
    <input type="radio" name="subject[weapons]" value="yes" <?php if(isset($subject['SubjectInfo']) && $subject['SubjectInfo']['weapons']=='yes') echo "checked='checked'";?> style="margin: 0 5px;" /> Yes 
    <input type="radio" name="subject[weapons]" value="no" <?php if(isset($subject['SubjectInfo']) && $subject['SubjectInfo']['weapons']=='no') echo "checked='checked'";?> style="margin: 0 5px;" /> No </td>
    <td>DESCRIBE<br />
...
<tr><td>BANK CARDS<br />
    <input type="radio" name="subject[bankcards]" value="yes" <?php if(isset($subject['SubjectInfo']) && $subject['SubjectInfo']['bankcards']=='yes') echo "checked='checked'";?> style="margin: 0 5px;" /> Yes 
    <input type="radio" name="subject[bankcards]" value="no" <?php if(isset($subject['SubjectInfo']) && $subject['SubjectInfo']['bankcards']=='no') echo "checked='checked'";?> style="margin: 0 5px;" /> No </td>
...
<tr><td>PHOTOGRAPHED<br />
    <input type="radio" name="product[photographed]" value="yes" <?php if(isset($product['ProductDInfo']) && $product['ProductDInfo']['photographed']=='yes') echo "checked='checked'";?> style="margin: 0 5px;" /> Yes 
    <input type="radio" name="product[photographed]" value="no" <?php if(isset($product['ProductDInfo']) && $product['ProductDInfo']['photographed']=='no') echo "checked='checked'";?> style="margin: 0 5px;" /> No</td>
<td>RELEASED TO PD<br />
    <input type="radio" name="product[released]" value="yes" <?php if(isset($product['ProductDInfo']) && $product['ProductDInfo']['released']=='yes') echo "checked='checked'";?> style="margin: 0 5px;" /> Yes 
    <input type="radio" name="product[released]" value="no" <?php if(isset($product['ProductDInfo']) && $product['ProductDInfo']['released']=='no') echo "checked='checked'";?> style="margin: 0 5px;" /> No</td>
    <td>RETAINED AT STORE<br />
    <input type="radio" name="product[retained]" value="yes" <?php if(isset($product['ProductDInfo']) && $product['ProductDInfo']['retained']=='yes') echo "checked='checked'";?> style="margin: 0 5px;" /> Yes 
    <input type="radio" name="product[retained]" value="no" <?php if(isset($product['ProductDInfo']) && $product['ProductDInfo']['retained']=='no') echo "checked='checked'";?> style="margin: 0 5px;" /> No</td></tr>
</table>
...
<tr><td>GIVEN TO SUBJECT 
    <input type="radio" name="notice[given]" value="yes" <?php if(isset($notice['NoticeInfo']) && $notice['NoticeInfo']['given']=='yes') echo "checked='checked'";?> style="margin: 0 5px;" /> Yes 
    <input type="radio" name="notice[given]" value="no" <?php if(isset($notice['NoticeInfo']) && $notice['NoticeInfo']['given']=='no') echo "checked='checked'";?> style="margin: 0 5px;" /> No</td></tr>
<tr><td>IF NO, WHY NOT? 
...
<table class="table table-bordered loss">
    ...
    <tr><td>ORC 
        <input type="radio" name="additional[orc]" value="yes" <?php if(isset($add['AdditionalInfo']) && $add['AdditionalInfo']['orc']=='yes') echo "checked='checked'";?> style="margin: 0 5px;" /> Yes 
        <input type="radio" name="additional[orc]" value="no" <?php if(isset($add['AdditionalInfo']) && $add['AdditionalInfo']['orc']=='no') echo "checked='checked'";?> style="margin: 0 5px;" /> No</td>
        <td>FORCE 
        <input type="radio" name="additional[force]" value="yes" <?php if(isset($add['AdditionalInfo']) && $add['AdditionalInfo']['force']=='yes') echo "checked='checked'";?> style="margin: 0 5px;" /> Yes 
        <input type="radio" name="additional[force]" value="no" <?php if(isset($add['AdditionalInfo']) && $add['AdditionalInfo']['force']=='no') echo "checked='checked'";?> style="margin: 0 5px;" /> No</td>
        <td>SHOPLIFT TOOL 
        <input type="radio" name="additional[shoplift]" value="yes" <?php if(isset($add['AdditionalInfo']) && $add['AdditionalInfo']['shoplift']=='yes') echo "checked='checked'";?> style="margin: 0 5px;" /> Yes 
        <input type="radio" name="additional[shoplift]" value="no" <?php if(isset($add['AdditionalInfo']) && $add['AdditionalInfo']['shoplift']=='no') echo "checked='checked'";?> style="margin: 0 5px;" /> No</td>
        <td>WEAPON USED 
        <input type="radio" name="additional[weapon_used]" value="yes" <?php if(isset($add['AdditionalInfo']) && $add['AdditionalInfo']['weapon_used']=='yes') echo "checked='checked'";?> style="margin: 0 5px;" /> Yes 
        <input type="radio" name="additional[weapon_used]" value="no" <?php if(isset($add['AdditionalInfo']) && $add['AdditionalInfo']['weapon_used']=='no') echo "checked='checked'";?> style="margin: 0 5px;" /> No</td>
        <td></td></tr>
</table>
<table class="table table-bordered loss">
