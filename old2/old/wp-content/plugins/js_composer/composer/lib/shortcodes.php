...
---------------------------------------------------------- */
    public function getColumnControls($controls) {
        $controls_start = '<div class="controls sidebar-nameE">';
        $controls_end = '</div>';
        ...
        $controls_column_size = '<a class="column_decrease" href="#" title="'.__('Decrease width', 'js_composer').'"></a> <span class="column_size">%column_size%</span> <a class="column_increase" href="#" title="'.__('Increase width', 'js_composer').'"></a>'; //</div>
        $controls_add = ' <a class="column_add" href="#" title="'.__('Add element', 'js_composer').'"></a>';
        ...
        $column_controls_full = $controls_start . $controls_column_size . $right_part_start . $controls_add . $controls_popup . $controls_edit . $controls_delete . $right_part_end . $controls_end;
